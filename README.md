...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3e47f93b-2741-4b46-a237-b9f483d06f7f
```

> `3e47f93b-2741-4b46-a237-b9f483d06f7f` is the password of the certificate, you can change it to any password you want.
